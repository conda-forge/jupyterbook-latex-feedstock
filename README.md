About jupyterbook-latex-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterbook-latex-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12216&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterbook-latex-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterbook-latex` can be installed with `conda`:
...
```
mamba install jupyterbook-latex
```

It is possible to list all of the versions of `jupyterbook-latex` available on your platform with `conda`:
...
```
mamba search jupyterbook-latex --channel conda-forge
```
...
mamba repoquery search jupyterbook-latex --channel conda-forge

# List packages depending on `jupyterbook-latex`:
mamba repoquery whoneeds jupyterbook-latex --channel conda-forge

# List dependencies of `jupyterbook-latex`:
mamba repoquery depends jupyterbook-latex --channel conda-forge
```
